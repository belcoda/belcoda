// @generated drizzle-zero signature:sha256:4d0305f631992dc2759c14f1b8c695577a7609259ce15cbff8b5e347ae1317d6
...
const userTable = {
	...
	columns: {
		...
		preferredLanguage: {
			type: 'string',
			optional: true,
			customType: null as unknown as 'id' | 'en' | 'fr' | 'ms' | 'pt' | 'es' | 'sw' | 'tl',
			serverName: 'preferred_language'
		},
		createdAt: {
			type: 'number',
