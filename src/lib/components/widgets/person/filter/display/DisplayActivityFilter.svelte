<script lang="ts">
	...
	const {
		mostRecentActivity,
		onRemove
	}: { mostRecentActivity: ListPersonsInput['mostRecentActivity']; onRemove: () => void } =
		$props();
