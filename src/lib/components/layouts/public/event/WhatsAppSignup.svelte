...
<ResponsiveModal bind:open={showQRModal}>
	<div class="py-6 text-center">
		...
		<h3 class="mb-2 text-lg font-semibold text-gray-900">Sign up via WhatsApp</h3>
		<p class="mb-6 text-sm text-gray-600">Choose how you'd like to proceed with your signup.</p>
		...
		{#if qrCodeDataUrl}
			<div class="mb-6 border-t border-gray-200 pt-6">
				<div class="mb-4 flex items-center justify-center gap-2">
					...
					<span class="text-sm font-medium text-gray-900">Or scan QR code</span>
				</div>
				<div class="flex flex-col items-center gap-4">
					<img src={qrCodeDataUrl} alt="WhatsApp Signup QR Code" class="rounded-lg border" />
					<p class="text-xs text-gray-500">Scan with your phone to sign up via WhatsApp</p>
				</div>
			</div>
		{/if}
	</div>
